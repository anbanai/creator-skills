...
- `output/context-brief.md`: 用户需求、项目定位、历史避重、选题理由、章节锚点。
- `output/02-outline.md`: 标题、钩子、章节结构、每节论点和素材方向。
...
- `output/03-article.md`: 初稿正文。
- `output/04-article-final.md`: humanizer 与合规预检后的最终正文。
- `output/content-quality-report.md`: 公众号文章预检结果。
